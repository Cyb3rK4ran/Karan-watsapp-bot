...
const getStats = () => {
    ...
    return `👋 𝗪𝗘𝗟𝗖𝗢𝗠𝗘 𝗧𝗢 𝗢𝗟𝗗-𝗦𝗧𝗨𝗗𝗜𝗢 𝗠𝗗\n\n` +
           `╭━━━〔 𝗕𝗢𝗧 𝗦𝗧𝗔𝗧𝗨𝗦 〕━━━┈⊷\n` +
                        ...
                        try {
                            ...
                            switch (commandName) {
                                ...
                                case 'menu': {
                                    ...
                                    let menuText = "";
                                    if (isBotOwner) {
                                        menuText = `𝗢𝗟𝗗-𝗦𝗧𝗨𝗗𝗜𝗢 𝗠𝗗-𝗕𝗢𝗧 𝗔𝗖𝗧𝗜𝗩𝗘\n` +
                                                   `╭━━━〔 𝗕𝗢𝗧 𝗦𝗧𝗔𝗧𝗨𝗦 〕━━━┈⊷\n` +
                                                   `┃ ⋄ .𝗽𝘂𝗯𝗹𝗶𝗰 / .𝗽𝗿𝗶𝘃𝗮𝘁𝗲\n` +
                                                   `┃ ⋄ .𝗮𝗻𝘁𝗶𝗱𝗲𝗹𝗲𝘁𝗲 𝗼𝗻/𝗼𝗳𝗳\n` +
                                                   `┃ ⋄ .𝘀𝘁𝗮𝘁𝘂𝘀 𝗼𝗻/𝗼𝗳𝗳\n` +
            ...
            this.sock.ev.on('connection.update', async (update) => {
                ...
                if (connection === 'close') {
                    ...
                    if (!this.onlineMessageSent) {
                        ...
                        const onlineMsg = `OLD-STUDIO-MD-BOT IS ONLINE ✅\n> *USE .MENU TO SEE ALL COMMAND*`;
